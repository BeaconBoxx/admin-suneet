      ...
      var ContactComponent = /*#__PURE__*/function () {
        function ContactComponent(route, _route, http, formBuilder, toastr) {
          ...
          this.errorHandling = function (control, error) {
            return _this3.contactForm.controls[control].hasError(error);
          };
          ...
          value: function getData() {
            ...
            this.http.get('cms/get-cms/').subscribe(function (res) {
              if (res.code == 200) {
                ...
                _this4.contact = res.data.contact;
                _this4.address = res.data.address;

                _this4.contactForm.controls["contact"].setValue(_this4.contact);

                _this4.contactForm.controls["email"].setValue(_this4.email);

                _this4.contactForm.controls["address"].setValue(_this4.address);
              }
            });
          }
        }, {
            ...
            if (this.contactForm.valid) {
              ...
              this.http.post('cms/create-update-cms/', body).subscribe(function (res) {
                if (res.code == 200) {
                  ...
                  _this5.toastr.success("Details updated successfully"); // this.toastr.success(res.message,'Success');


                  _this5.getData(); // this.Srvc.searchdata();
          ...
          value: function GetFaq() {
            ...
            this.Srvc.get("cms/get-faq/").subscribe(function (res) {
              if ([200, 201].includes(res.code)) {
                _this6.setSpecifications(res.data);

                _this6.IdData = res === null || res === void 0 ? void 0 : res.data;
              }
            });
          }
        }, {
      ...
      var PrivacyComponent = /*#__PURE__*/function () {
        ...
        _createClass(PrivacyComponent, [{
          ...
          value: function getCms() {
            ...
            this.http.get('cms/get-cms/').subscribe(function (res) {
              if (res.code == 200) {
                _this10.privacy = res.data.privacy;
              }
            });
          }
        }, {
