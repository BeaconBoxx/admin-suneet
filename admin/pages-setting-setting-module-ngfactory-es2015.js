...
class ProfileComponent {
    constructor(commn_, fb, toastr) {
        ...
        this.profileForm = this.fb.group({
            ...
            phone_no: ['', { disabled: true }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(7), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(15)]],
            email: ['', { disabled: true }, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].email, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$')]],
    ...
    getProfile() {
        this.commn_.get("user/get-user-profile-by-token/").subscribe(res => {
            ...
            this.profileForm.get('phone_no').patchValue((_f = res === null || res === void 0 ? void 0 : res.data) === null || _f === void 0 ? void 0 : _f.phone_no);
        });
    }
    update() {
        let body = {
